...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        pitcure = new QLabel(analysispage);
        pitcure->setObjectName(QString::fromUtf8("pitcure"));
        pitcure->setGeometry(QRect(60, 70, 840, 700));
        label_2 = new QLabel(analysispage);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(980, 110, 181, 51));
        QFont font8;
        font8.setFamily(QString::fromUtf8("\346\245\267\344\275\223"));
        font8.setPointSize(30);
        label_2->setFont(font8);
        env_set = new QComboBox(analysispage);
        env_set->setObjectName(QString::fromUtf8("env_set"));
        env_set->setGeometry(QRect(1180, 110, 161, 51));
        env_set->setFont(font2);
        groupBox_2 = new QGroupBox(analysispage);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        groupBox_2->setGeometry(QRect(980, 220, 471, 331));
        groupBox_2->setFont(font4);
        groupBox_2->setAlignment(Qt::AlignCenter);
        envTDSlable = new QLabel(groupBox_2);
        envTDSlable->setObjectName(QString::fromUtf8("envTDSlable"));
        envTDSlable->setGeometry(QRect(60, 50, 101, 41));
        envTDSlable->setFont(font8);
        envTDS = new QLabel(groupBox_2);
        envTDS->setObjectName(QString::fromUtf8("envTDS"));
        envTDS->setGeometry(QRect(160, 50, 281, 41));
        envTDS->setFont(font8);
        envPHlable_2 = new QLabel(groupBox_2);
        envPHlable_2->setObjectName(QString::fromUtf8("envPHlable_2"));
        envPHlable_2->setGeometry(QRect(60, 120, 101, 41));
        envPHlable_2->setFont(font8);
        envPH = new QLabel(groupBox_2);
        envPH->setObjectName(QString::fromUtf8("envPH"));
        envPH->setGeometry(QRect(160, 120, 281, 41));
        envPH->setFont(font8);
        envTEMlable_3 = new QLabel(groupBox_2);
        envTEMlable_3->setObjectName(QString::fromUtf8("envTEMlable_3"));
        envTEMlable_3->setGeometry(QRect(60, 190, 101, 41));
        envTEMlable_3->setFont(font8);
        envTEM = new QLabel(groupBox_2);
        envTEM->setObjectName(QString::fromUtf8("envTEM"));
        envTEM->setGeometry(QRect(160, 190, 281, 41));
        envTEM->setFont(font8);
        envTUlable_4 = new QLabel(groupBox_2);
        envTUlable_4->setObjectName(QString::fromUtf8("envTUlable_4"));
        envTUlable_4->setGeometry(QRect(60, 260, 101, 41));
        envTUlable_4->setFont(font8);
        envTU = new QLabel(groupBox_2);
        envTU->setObjectName(QString::fromUtf8("envTU"));
        envTU->setGeometry(QRect(160, 260, 281, 41));
        envTU->setFont(font8);
        set = new QPushButton(analysispage);
        set->setObjectName(QString::fromUtf8("set"));
        set->setGeometry(QRect(1360, 110, 91, 51));
        set->setFont(font4);
        set_diy = new QPushButton(analysispage);
        set_diy->setObjectName(QString::fromUtf8("set_diy"));
        set_diy->setGeometry(QRect(990, 810, 471, 81));
        QFont font9;
        font9.setFamily(QString::fromUtf8("\346\245\267\344\275\223"));
        font9.setPointSize(40);
        set_diy->setFont(font9);
        TDSset = new QTextEdit(analysispage);
        TDSset->setObjectName(QString::fromUtf8("TDSset"));
        TDSset->setGeometry(QRect(1110, 600, 101, 41));
        TDSset->setFont(font6);
        TDSdiy = new QLabel(analysispage);
        TDSdiy->setObjectName(QString::fromUtf8("TDSdiy"));
        TDSdiy->setGeometry(QRect(980, 600, 101, 41));
        TDSdiy->setFont(font8);
        PHdiy = new QLabel(analysispage);
        PHdiy->setObjectName(QString::fromUtf8("PHdiy"));
        PHdiy->setGeometry(QRect(1240, 600, 101, 41));
        PHdiy->setFont(font8);
        TEMdiy = new QLabel(analysispage);
        TEMdiy->setObjectName(QString::fromUtf8("TEMdiy"));
        TEMdiy->setGeometry(QRect(980, 700, 101, 41));
        TEMdiy->setFont(font8);
        TUdiy = new QLabel(analysispage);
        TUdiy->setObjectName(QString::fromUtf8("TUdiy"));
        TUdiy->setGeometry(QRect(1240, 710, 101, 41));
        TUdiy->setFont(font8);
        PHset = new QTextEdit(analysispage);
        PHset->setObjectName(QString::fromUtf8("PHset"));
        PHset->setGeometry(QRect(1350, 600, 101, 41));
        PHset->setFont(font6);
        TUset = new QTextEdit(analysispage);
        TUset->setObjectName(QString::fromUtf8("TUset"));
        TUset->setGeometry(QRect(1350, 710, 101, 41));
        TUset->setFont(font6);
        TEMset = new QTextEdit(analysispage);
        TEMset->setObjectName(QString::fromUtf8("TEMset"));
        TEMset->setGeometry(QRect(1110, 710, 101, 41));
        TEMset->setFont(font6);
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        pitcure->setText(QString());
        label_2->setText(QApplication::translate("Form", "\345\275\223\345\211\215\345\234\272\346\231\257\357\274\232", nullptr));
        groupBox_2->setTitle(QApplication::translate("Form", "\345\275\223\345\211\215\347\216\257\345\242\203\346\212\245\350\255\246\351\230\210\345\200\274", nullptr));
        envTDSlable->setText(QApplication::translate("Form", "TDS:", nullptr));
        envTDS->setText(QApplication::translate("Form", "10.00 - 10.00", nullptr));
        envPHlable_2->setText(QApplication::translate("Form", "PH :", nullptr));
        envPH->setText(QApplication::translate("Form", "10.00 - 10.00", nullptr));
        envTEMlable_3->setText(QApplication::translate("Form", "TEM:", nullptr));
        envTEM->setText(QApplication::translate("Form", "10.00 - 10.00", nullptr));
        envTUlable_4->setText(QApplication::translate("Form", "TU :", nullptr));
        envTU->setText(QApplication::translate("Form", "10.00 - 10.00", nullptr));
        set->setText(QApplication::translate("Form", "\350\256\276\347\275\256", nullptr));
        set_diy->setText(QApplication::translate("Form", "\346\267\273\345\212\240\345\234\272\346\231\257", nullptr));
        TDSdiy->setText(QApplication::translate("Form", "TDS:", nullptr));
        PHdiy->setText(QApplication::translate("Form", "PH:", nullptr));
        TEMdiy->setText(QApplication::translate("Form", "TEM:", nullptr));
        TUdiy->setText(QApplication::translate("Form", "TU:", nullptr));
        ...
        linechart->setText(QApplication::translate("Form", "\345\256\236\346\227\266\347\233\221\346\265\213", nullptr));
        ...
        analysis->setText(QApplication::translate("Form", "\345\234\272\346\231\257\350\256\276\347\275\256", nullptr));
        check->setText(QApplication::translate("Form", "\350\256\276\345\244\207\347\212\266\346\200\201", nullptr));
